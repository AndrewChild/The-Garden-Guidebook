...
Route(name='Deliverance',
      ...
      rating=2,
      FA='Nick Scarpelli',
      description='Sit start and climb the steep roof starting with a left hand side pull and right hand on an obvious ripple in the right facing rib. Top as for Monorail.') 
...
Route(name='Teenage Libertarians',
      ...
      rating=3,
      FA='Nick Koch',
      description='Start as for chicken tendies but traverse right and ascend the center of the face toping at the tallest part of the boulder.')
...
Variation(name='Trivial Solution',
          grade=0,
          rating=1,
          parent=book.routes['Monorail'],
          description='Start as for Monorail but climb straight up.') 
...
Variation(name='Step on my Beard',
          grade='4',
          rating=3,
          FA='Andrew Child',
          parent=book.routes['Teenage Libertarians'],
          description='Start as for Teenage Libertarians but continue to the right using holds in a right facing rib to reach the top.') 
