...
\newpage
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/out/redneck_c.png}\label{sm:Redneck Riviera area map}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/45_c.png}\label{tp:4.5}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
