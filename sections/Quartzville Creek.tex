...
\phantomsection\label{sm:Redneck Riviera area map}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/area/out/redneck_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Redneck Riviera_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Redneck Riviera_qr.png}
\end{center}
\begin{center}
...
\phantomsection\label{tp:Monorail}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Quartz/Monorail_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Yo Mamma}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Quartz/YoMamma_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:4.5}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Quartz/45_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Old Miner's Camp_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Old Miner's Camp_qr.png}
\end{center}
\begin{center}
...
\phantomsection\label{tp:Dab Rig}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Quartz/DabRig_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
