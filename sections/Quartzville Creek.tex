...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./maps/qr//Redneck Riviera_qr.png}}% Store image in \box0
...
Redneck rivierra is located on Quartzville road apporximately 20.6 miles from highway 20 park in the gravel pull out on the creek side of the road. This is a nice spot with good swimming access and a few established routes on both sides of the river. The locals like to use this spot to pan for gold. Often they are friendly and willing to share the space.\\
...
\needspace{10em}
\subsection*{Mono Rail}\phantomsection\label{bf:Mono Rail}
...
\needspace{2em}
\phantomsection\label{vr:Monorail Extention Project}
\colorbox{black!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
2a Monorail Extention Project V?  
}}}
\begin{adjustwidth}{1.3em}{}			
...
\needspace{2em}
\phantomsection\label{rt:Megarail Project}
\colorbox{black!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
3 Megarail Project V?  
}}}
\begin{adjustwidth}{1.3em}{}			

Sit start and climb the steep roof using right facing rib. Top as for Monorail or travers out left.
  (No Topo)
\end{adjustwidth}
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./maps/qr//Old Miner's Camp_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
