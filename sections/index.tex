...
\rowcolors{2}{MidnightBlue!10}{white}
\begin{supertabular}{p{0.76\linewidth}p{0.08\linewidth}}
Andrew Child & \pageref{pt:Riptide} \\
Andrew Child & \pageref{pt:Fight Club} \\
Andrew Child & \pageref{pt:Octernal} \\
Andrew Child & \pageref{pt:Butterfly} \\
Andrew Child & \pageref{pt:2blows} \\
Carson Dension & \pageref{pt:Smackdown} \\
Michael Gardener Brown & \pageref{pt:Ground up Blowie} \\
\end{supertabular}
\end{center}
\end{flushleft}
\onecolumn
