...
\setbox0=\hbox{\includegraphics[width=0.4\linewidth]{./images/maps/qr//Clear Cut Boulders_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{minipage}[c]{0.5\linewidth}{
\includegraphics[width=0.8\linewidth]{./images/maps/qr//Clear Cut Boulders_qr.png}}
\end{minipage}
\begin{minipage}[c]{0.5\linewidth}{
\textcolor{blue}{\parbox{0.8\linewidth}{\href{http://maps.google.com/maps?q=44.43480966863281,-122.5974049928017}{\ul{Navigate to this area}}}}}
\end{minipage}
\\
\\
...
\phantomsection\label{tp:Star Gazer}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/ClearCut/StarGazer_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Dig Dug}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/ClearCut/DigDug_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Grizzly Face}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/ClearCut/GrizzlyFace_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/ClearCut/GrizzlyFace_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Bear Back}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/ClearCut/BearBack_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Double Stump}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/ClearCut/DoubleStump_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/ClearCut/DoubleStump_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Double Stump 2}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/ClearCut/DoubleStump2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/ClearCut/DoubleStump2_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\phantomsection\label{tp:Cuneiform}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/ClearCut/Cuneiform_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/ClearCut/Cuneiform_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{10em}
