...
This guidebook has been maintained as a living document since 2022. Some details are still missing from more obscure routes and new information is being added all the time as route development continues. If you would like to contribute your knowledge to this project, please get in touch with me (I can be contacted via GitHub or my personal email: an.child@gmail.com). Every time this guidebook is updated the latest version is uploaded as a PDF to the project website, follow the QR code below to download the latest version.
\setbox0=\hbox{\includegraphics[width=0.4\linewidth]{./images/maps/qr/The Garden_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{minipage}[c]{0.5\linewidth}{
\includegraphics[width=0.8\linewidth]{./images/maps/qr/The Garden_qr.png}}
\end{minipage}
\begin{minipage}[c]{0.5\linewidth}{
\textcolor{blue}{\parbox{0.8\linewidth}{\href{https://github.com/AndrewChild/The-Garden-Guidebook/raw/main/guideBook.pdf}{\ul{Get the latest revision of this book}}}}}
\end{minipage}
\section{Navigation}
This book uses hand drawn maps to show the layout of most areas, additionally the approximate GPS locations of most formations are provided in the index, although in many areas GPS accuracy is poor. A complete GPS map is available via Caltopo, this map is manually maintained and may not always be up to date.
...
\end{minipage}
\begin{minipage}[c]{0.5\linewidth}{
\textcolor{blue}{\parbox{0.8\linewidth}{\href{https://caltopo.com/m/N1LQH2A}{\ul{Caltopo map of formations}}}}}
\end{minipage}
\section{Amenities}
\subsection*{Toilets}
...
\begin{center}			  
\begin{overpic}[width=0.9\linewidth]{./images/photos/Cricket.jpg}
...
\phantomsection\label{pt:Riptide}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/photos/Riptide.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.9\linewidth-0.1\linewidth}{
\textcolor{white}{
Rob Crouch on Riptide. \vpageref[][Description]{rt:Riptide}
}}}}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/photos/Riptide.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.9\linewidth-0.1\linewidth}{
\textcolor{white}{
Rob Crouch on Riptide. \vpageref[][Description]{rt:Riptide}
...
\phantomsection\label{pt:Petes}
\begin{center}			  
\begin{overpic}[width=\linewidth]{./images/photos/petes.JPG}
\put (0,5) {\colorbox{\chapterColor}{\parbox{0.7\linewidth}{\textcolor{white}{Eric Bailey on Right Arête (Pete's Rail) circa 2002. \vpageref[][Description]{rt:PR_1}}}}}
\end{overpic}
\end{center}		