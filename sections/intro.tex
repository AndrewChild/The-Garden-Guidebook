...
\end{minipage}
\section{Navigation}
This book uses hand drawn maps to show the layout of most areas, additionally the approximate GPS locations of most formations are provided in the index in many areas GPS accuracy is poor. A complete GPS map is available via Caltopo, this map is manually maintained and may not always be up to date.
