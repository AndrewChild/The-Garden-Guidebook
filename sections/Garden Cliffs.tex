...
\end{adjustwidth}
	...
	\end{multicols}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/butterfly.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.7\linewidth}{\textcolor{white}{Griffin on Butterfly Effect. (Page \pageref{rt:Butterfly Effect})}}}}

	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/butterfly.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.7\linewidth}{\textcolor{white}{Griffin on Butterfly Effect. (Page \pageref{rt:Butterfly Effect})}}}}
\label{pt:Butterfly}
	\end{overpic}
	\end{center}
	\raggedcolumns
