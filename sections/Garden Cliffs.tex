...
55', Sport, 7 bolts. Start on the left side of a small cave and climb the aesthetic pillar.
\end{adjustwidth}
...
45', Sport, 6 bolts. Start on a big sloping rail and pull a few moves to reach good edges and maneuver your way under a hanging block. Crank some big moves to get up and around the block onto easier terrain.
\end{adjustwidth}
...
\end{adjustwidth}
	...
	\end{multicols}
\phantomsection\label{pt:Butterfly}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/butterfly.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
Griffin on Butterfly Effect. \vpageref[][Description]{rt:Butterfly Effect}
}}}}

	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/butterfly.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
Griffin on Butterfly Effect. \vpageref[][Description]{rt:Butterfly Effect}
