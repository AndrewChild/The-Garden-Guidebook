...
\phantomsection\label{tp:Garden Cliff Castle Black Area}
  \begin{landscape}
	\includepdf[angle=90, picturecommand*={}]{./images/maps/topos/Cliffs/castle2_c.pdf}
  \end{landscape}
...
\phantomsection\label{tp:Thunderdome}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Cliffs/thunderDome2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Cliffs/thunderDome2_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{10em}
