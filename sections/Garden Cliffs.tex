...
\needspace{2em}
\phantomsection\label{rt:P.R.O.M.}
\colorbox{Goldenrod!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
21 P.R.O.M. 5.13b/c  
...
The original line of the Heirloom project stays left when the P.R.O.M. boltline veers right at the top.
  (No Topo)
\end{adjustwidth}
