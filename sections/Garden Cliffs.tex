...
\phantomsection\label{am:The Garden Cliff Overview}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/Cliffs_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/Cliffs_c.png}
	\end{overpic}
	\end{center}
\includegraphics[width=\linewidth]{./images/maps/plots//Garden Cliffs.png}
\setbox0=\hbox{\includegraphics[width=0.4\linewidth]{./images/maps/qr//Garden Cliffs_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{minipage}[c]{0.5\linewidth}{
\includegraphics[width=0.8\linewidth]{./images/maps/qr//Garden Cliffs_qr.png}}
\end{minipage}
\begin{minipage}[c]{0.5\linewidth}{
...
\phantomsection\label{tp:Garden Cliff Right Side}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Cliffs/cliffs_main_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Cliffs/cliffs_main_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
14 Butterfly Effect 5.13a/b \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
40', Sport, 6 bolts. Climbs more or less straight up through a low bolcky ledge followed by thin crimps and a bouldery roof pull. Reportedly climbs like low 5.12 endurance into V7/8 with no rest. The middle of the route is equipped with permas.
\end{adjustwidth}
\needspace{2em}
...
\phantomsection\label{tp:Garden Cliff Skink Area}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Cliffs/skink_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Cliffs/skink_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{2em}
...
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:Lenticular Cloud}
\colorbox{Goldenrod!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
19 Lenticular Cloud 5.12d \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\begin{adjustwidth}{1.3em}{}			
Climbs the steep column to the left of Chimeras. Links into the top of Littlest Birds.
  (No Topo)
\end{adjustwidth}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
25 Littlest Birds 5.11b \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
26 Seraphim Nachash 5.11b/c \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
27 My Empire of Dirt 5.12b \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:Spin Glass}
\colorbox{Goldenrod!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
28 Spin Glass 5.12c  
...
\begin{adjustwidth}{1.3em}{}			
50', Sport, 9 bolts. Start on a narrow ledge to the right of the top of the stairs.
\end{adjustwidth}
\begin{adjustwidth}{0.5cm}{}				
\needspace{4em}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
28a Honeycomb Traverse 5.12a \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
50', Sport, 9 bolts. Start on Criss Cross Apple Sauce and traverse into Spin Glass (formerly known as the Honeycomb Project) after the third bolt. Avoids the blank section down low.
\end{adjustwidth}
\end{adjustwidth}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
29 Criss Cross Applesauce 5.11c \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
30 Vandals in the Graveyard 5.12a \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:cliffs_proj_3}
\colorbox{black!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
31 Open Project V?  
...
\begin{adjustwidth}{1.3em}{}			
The route to the left of Vandals was a closed project, but it was opened up by the developer after he tore his meniscus climbing on it.
  (No Topo)
\end{adjustwidth}
	\end{multicols}
\phantomsection\label{tp:Garden Cliff Castle Black Area}
  \begin{landscape}
	\includepdf[angle=90, picturecommand*={}]{./images/maps/topos/Cliffs/castle2_c.png}
  \end{landscape}
\phantomsection\label{tp:Garden Cliff Nest Area}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Cliffs/nest2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Cliffs/nest2_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
32 Ovulation Send-sation 5.12a \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
32a Ovulation Send-sation Extension 5.12a*  
}}}
\begin{adjustwidth}{1.3em}{}			
...
\begin{adjustwidth}{1.3em}{}			
The bolt line in the corner to the left of Fertile Crescent has been abandoned for many years.
  (No Topo)
\end{adjustwidth}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
35 My Secret Garden 5.11a \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
37 A Garden Called Peace 5.10a \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Fairy Tale Wall}
	\setbox0=\hbox{\begin{overpic}[width=0.75\linewidth]{./images/maps/topos/Cliffs/fairytale2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/Cliffs/fairytale2_c.png}
	\end{overpic}
	\end{center}
\newpage
	\begin{multicols}{2}
	\end{multicols}
\phantomsection\label{tp:Cabbage Patch}
	\setbox0=\hbox{\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Cliffs/cabbage_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Cliffs/cabbage_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
...
\textbf{NOTE: This area is located in a huge blackberry patch the trail to this cliff and some of the routes are overgrown with blackberries which must be cleared each spring.}\\
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
1 Don't Forget the Nooch 5.4 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
30', Sport 3 Bolts. Follow a right facing corner crack up a low angle slope. Seeps in spring, usually dirty.
\end{adjustwidth}
\needspace{2em}
...
\begin{adjustwidth}{1.3em}{}			
30', Sport 4 Bolts. Follow the bolt line up a shallow left facing corner. The bolts are unfortunately placed in a water streak and may be covered in mud and vegetation.
\end{adjustwidth}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
3 Babaganoush 5.10b \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
30', Sport 4 Bolts. A bouldery sequence in a right facing corner gives way to a bulbous ledge at the first bolt followed by 5.easy terrain to the top.
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:cliffs_proj_5}
\colorbox{black!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
4 Open Project V?  
...
\begin{adjustwidth}{1.3em}{}			
30', Sport 3 Bolts. A section of dirty and friable rock leads up a slight overhang. Difficulty eases as the cliff slabs out at the third bolt.
\end{adjustwidth}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
5 Kim Chi Corner 5.11a*  
}}}
\begin{adjustwidth}{1.3em}{}			
30', Sport 5 Bolts. Vertical climbing follows a 20' right facing corner to a horizontal seam followed by slab to the top.
\end{adjustwidth}
	\end{multicols}
\phantomsection\label{tp:Thunderdome}
	\setbox0=\hbox{\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Cliffs/thunderDome2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Cliffs/thunderDome2_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{10em}
\subsection*{Johnny Cash's Thunderdome}\phantomsection\label{bf:Thunderdome}
\needspace{2em}
\phantomsection\label{rt:Where Do You Go When the Sun Goes Down}
\colorbox{RoyalBlue!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6 Where Do You Go When the Sun Goes Down 5.11a*  
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6a A Victem of the Times 5.10c*  
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
8 I Fell for You Like a Child 5.8 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
9 I Will Let You Down 5.6 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
10 A Million Dollars of Good 5.8 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
11 Stop Once to Wipe the Sweat Away 5.10a \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
