...
\phantomsection\label{tp:Fairy Tale Wall}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Cliffs/fairytale2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Cliffs/fairytale2_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
