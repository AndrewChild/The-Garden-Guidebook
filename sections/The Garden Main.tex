...
\end{adjustwidth}
	...
	\includepdf[picturecommand*={\label{pt:Ground up Blowie}\put (10,10) {\colorbox{\chapterColor}{\parbox{0.6\paperwidth}{\textcolor{white}{Andrew strugling to finde a finger lock on Ground up Blowie (Page \pageref{rt:Ground up Blowie})}}}}
}]{./images/blowie.jpg}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/koan_c.png}\label{tp:Zen Koan}
	\end{overpic}
	\end{center}
...
\parbox{0.95\linewidth}{
\textbf{
15 Zen Koan* V2 \ding{72}\ding{72} 
}}}
