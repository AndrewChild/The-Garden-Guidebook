...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
17a Turtle Traverse V3/4 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			

Start as for Leonardo, but stay low and traverse left into Raphael Crack.
\end{adjustwidth}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6 The Ear V3 \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
A cave directly behind Azain Spire is mostly full of bats and trash.\\
