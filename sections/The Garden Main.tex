...
\parbox{0.95\textwidth}{
\textbf{
2 Daryl Philbin V1 \ding{72} \ding{72} \ding{72}  \warn 
}
}
}
...
6 Fight Club Left V?  
					...
					\begin{adjustwidth}{0.5cm}{}				
					A popular local project. Sit start with hands matched low on the left arete of the overhanging boulder. Climb across the overhang topping as for fightclub. Unclear if this has ever been climbed.
					\end{adjustwidth}
					\end{minipage}
					\begin{minipage}{\linewidth}	
					\label{rt:Brewmaster}
...
7 Brewmaster V5 \ding{72} \ding{72}  
					...
					\begin{adjustwidth}{0.5cm}{}				
					Often mistaken for fight club left. Sit start in the same spot but climb up the arete. Starting a move or two in brings the grade down a bit.
					\end{adjustwidth}
					\end{minipage}
			\begin{minipage}{\columnwidth}
...
\parbox{0.95\textwidth}{
\textbf{
9 Trust V2 \ding{72} \ding{72} \ding{72}  
}
}
}
...
\parbox{0.95\textwidth}{
\textbf{
11 Austin Powers V5 \ding{72} \ding{72}  
}
}
}
...
\parbox{0.95\textwidth}{
\textbf{
12a Mr. Bigglesworth V1 \ding{72} \ding{72}  
}
}
}
...
\parbox{0.95\textwidth}{
\textbf{
13 E's Dirty B V5 \ding{72} \ding{72}  
}
}
}
...
\parbox{0.95\textwidth}{
\textbf{
4 Leave It to Jesus V2 \ding{72} \ding{72} \ding{72}  
}
}
}
...
4a Leave it to Jesus Sit Start V8*  
							...
							\end{minipage}
						\end{adjustwidth}
						\fullPic{./maps/topos/octurnal_c.png}
...
\parbox{0.95\textwidth}{
\textbf{
8 Octurnal V7 \ding{72} \ding{72} \ding{72}  
}
}
}
...
\parbox{0.95\textwidth}{
\textbf{
8a Octurnal Direct Exit V7 \ding{72} \ding{72} \ding{72}  
}
}
}
...
\parbox{0.95\textwidth}{
\textbf{
8b Octurnal Center Exit V6/7 \ding{72} \ding{72}  
}
}
}
...
\parbox{0.95\textwidth}{
\textbf{
8c Sweethome Traverse V4 \ding{72} \ding{72}  
}
}
}

							\begin{adjustwidth}{0.5cm}{}				
							Climb Octurnal from the ledge.
								\newline (No Topo) 
							\end{adjustwidth}
							\end{minipage}
						\end{adjustwidth}
...
17 Bubbler V5*  
					...
					\end{minipage}
\newpage
				\halfPic{./maps/subarea/big_c.png}{Big area map}
...
5 Smol* V2 \ding{72}  
					...
					\end{minipage}
\newpage
				\fullPic{./maps/subarea/azain_c.png}
...
\parbox{0.95\textwidth}{
\textbf{
7 Ground Up Blowie V5 \ding{72} \ding{72}  
}
}
}
...
\parbox{0.95\textwidth}{
\textbf{
14 Garden Variety V7*  
}
}
}

					\begin{adjustwidth}{0.5cm}{}				
					Reportedly there is a way to jump start the center of the overhanging face.
					\end{adjustwidth}
					\end{minipage}
					\begin{minipage}{\linewidth}	
