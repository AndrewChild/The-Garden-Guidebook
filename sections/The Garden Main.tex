...
\phantomsection\label{am:The Garden Main Area Overview}
	\includepdf[landscape=true, picturecommand*={}]{./maps/area/out/Garden_c.pdf}
...
\phantomsection\label{tp:Methlab Backside}
	\includepdf[landscape=true, picturecommand*={}]{./maps/topos/Methlab_c.pdf}
...
\phantomsection\label{tp:Night Crawler}
...
\needspace{3em}
\subsection*{Night Crawler}\phantomsection\label{bf:Night Crawler}
...
\needspace{2em}
\phantomsection\label{rt:Night Crawler}
\colorbox{red!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
...
\phantomsection\label{tp:arboretum2}
	\includepdf[landscape=true, picturecommand*={}]{./maps/topos/childOfGod_c.pdf}
