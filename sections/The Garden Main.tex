\phantomsection\label{am:The Garden Main Area Overview}
  \begin{landscape}
	\includepdf[angle=90, picturecommand*={}]{./images/maps/area/out/Garden_c.png}
  \end{landscape}
\thispagestyle{empty}
...
\raggedcolumns
\begin{multicols}{2}
\includegraphics[width=\linewidth]{./images/maps/plots//The Garden Main.png}
\setbox0=\hbox{\includegraphics[width=0.4\linewidth]{./images/maps/qr//The Garden Main_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{minipage}[c]{0.5\linewidth}{
\includegraphics[width=0.8\linewidth]{./images/maps/qr//The Garden Main_qr.png}}
\end{minipage}
\begin{minipage}[c]{0.5\linewidth}{
\textcolor{blue}{\parbox{0.8\linewidth}{\href{http://maps.google.com/maps?q=44.44076010641458,-122.5752659013521}{\ul{Navigate to this area}}}}}
\end{minipage}
\\
\\
...
\phantomsection\label{sm:Entrance Area map}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/entrance_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/entrance_c.png}
	\end{overpic}
	\end{center}
...
\phantomsection\label{tp:Toilet Bowl}
	\setbox0=\hbox{\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/toilet_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/toilet_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\needspace{2em}
\phantomsection\label{rt:Goosebumps}
...
\begin{adjustwidth}{1.3em}{}			
Bunchy start in the pit on the left side of the boulder with hands in compression on a column-like blob. Top on the left side of the boulder.
\end{adjustwidth}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
4 Overhand V8 \ding{72}\ding{72} \warn
}}}
\begin{adjustwidth}{1.3em}{}			
...
\needspace{4em}
\needspace{2em}
\phantomsection\label{vr:Uppercut}
\colorbox{red!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
4a Uppercut V9/10  
...
\begin{adjustwidth}{1.3em}{}			
Start on Goosebumps and link into Overhand.
  (No Topo)
\end{adjustwidth}
\end{adjustwidth}
\needspace{2em}
...
\phantomsection\label{tp:Boys in the Woods}
	\includepdf[picturecommand*={}]{./images/maps/topos/Main/overhand_boys_c.png}
	\begin{multicols}{2}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6 Boys in the Woods V4 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
7 Cuba Gooding V6 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
8 Ice Cubes Shiny Jerry Curl V6 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Spider Bumps}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/spiderBumps_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/spiderBumps_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
9 Spider Bumps V5 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Start on a thin crimp rail over am in-the-way rock. Maneuver yourself to a good jug using almost non existent holds while trying not to dab.
\end{adjustwidth}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
10 Tree Slab V1+ \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
11 The Good Warm Up V0 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:The Good Warm Up}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/goodWarmUp_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/goodWarmUp_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
12a Pure Tonsil V6 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Tonsil}
	\setbox0=\hbox{\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/tonsil2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/tonsil2_c.png}
	\end{overpic}
	\end{center}
\phantomsection\label{tp:All Sorts of Ease}
	\setbox0=\hbox{\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/ease_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/ease_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
14 All Sorts of Ease VB \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
15 In the Shadow of Giants V2 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Three Star Ledge}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/threeStar2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/threeStar2_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
16 Three Star Ledge V2 \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Turtle}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/turtle_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/turtle_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
19a Turtle Traverse V4 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{sm:Fight Club Area map}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/fightClub_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/fightClub_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
...
\begin{adjustwidth}{1.3em}{}			
Climb the left side of the face on the back side of the office boulder. This route has likely been climbed and is documented many times under different names, but the details have been lost to time.
  (No Topo)
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:Mr. Torrance}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6 Mr. Torrance V3 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Start on right facing crimps on the right side of the face. Climb left on good feet and bad hands until you can rock over onto the slab and top.
\end{adjustwidth}
\phantomsection\label{tp:Sanitarium}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/Sanitarium_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/Sanitarium_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
\subsection*{Sanitarium Spire}\phantomsection\label{bf:Sanitarium Spire}
A small spire directly uphill of The Office.\\
\needspace{2em}
\phantomsection\label{rt:So Easy}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
7 So Easy V0 \ding{73} 
}}}
\begin{adjustwidth}{1.3em}{}			
Start on head high holds and climb the triangular face on loose holds.
\end{adjustwidth}
	\end{multicols}
\phantomsection\label{tp:Office}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/office_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/office_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{10em}
...
\phantomsection\label{tp:Fight Club Right Side}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/fightClub_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/Main/fightClub_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
9 The Ear V3 \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
10 Fight Club V8 \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
11 Fight Club 2 V10 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Fight Club Left Side}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/fightClub2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/Main/fightClub2_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
12 Brewmaster V5 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Trust}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/trust_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/trust_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
16 Trust V2 \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Mini Me}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/miniMe_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/miniMe_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
18 Austin Powers V5 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Mini Me 2}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/drEvil_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/Main/drEvil_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
19a Mr. Bigglesworth V1 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
20 Green Hell V2 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
21 E's Dirty B V5 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:E's Dirty B}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/eDirty_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/Main/eDirty_c.png}
	\end{overpic}
	\end{center}
\newpage
\phantomsection\label{sm:Undertow area map}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/undertow_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/undertow_c.png}
	\end{overpic}
	\end{center}
...
\phantomsection\label{tp:Undertow2}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/undertow2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/Main/undertow2_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{10em}
...
\phantomsection\label{tp:Undertow}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/undertow_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/undertow_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\phantomsection\label{tp:Car Alarm Downhill Side}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/carAlarm_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/carAlarm_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{2em}
...
\phantomsection\label{tp:Car Alarm Uphill Side}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/carAlarm2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/carAlarm2_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\phantomsection\label{tp:Chock Stone}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/chockstone_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/chockstone_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
13 Chock Stone Highball V4*  \warn\warn
}}}
\begin{adjustwidth}{1.3em}{}			
Climbing this alluring prow to the apex reportedly goes at around V4. Bring a lot of pads.
\end{adjustwidth}
\phantomsection\label{tp:Bubonic Plague}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/koan_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/koan_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Hanging Prow Project}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/prowProj_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/prowProj_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
15 Headbanger's Ball V8 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{sm:Meth Lab area map}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/methLab_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/methLab_c.png}
	\end{overpic}
	\end{center}
...
\phantomsection\label{tp:Jesus}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/jesus_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/jesus_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
4a Leave it to Jesus Sit Start V9 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Sit start on razor crimps to the lower left of the stand start. This climb has evolved due to multiple hold breaks.
\end{adjustwidth}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
5b Home Depot V8 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Climb Harbor Freight but head right at the top through a slot crimp to finish near the top out for Octernal. [Extension Cord, V9] Optionally, continue traversing by down climbing the Sweet Home Traverse and finish as for Octernal Direct.
\end{adjustwidth}
\end{adjustwidth}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6 Heisenburg V7 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Methlab Backside}
  \begin{landscape}
	\includepdf[angle=90, picturecommand*={}]{./images/maps/topos/Main/Methlab_c.png}
  \end{landscape}
	\begin{multicols}{2}
\phantomsection\label{tp:octernal2}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/octurnal2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/octurnal2_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
9 Two Blows One Stroke V6 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Southern Discomfort}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/soDisco_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/soDisco_c.png}
	\end{overpic}
	\end{center}
\phantomsection\label{tp:Swollen Member}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/swollen2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/swollen2_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Turd Party}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/turdParty_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/turdParty_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Gargoyle}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/eboulder3_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/Main/eboulder3_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Slam dunk}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/eboulder2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/eboulder2_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\needspace{4em}
\needspace{2em}
\phantomsection\label{vr:Z's VB}
\colorbox{Goldenrod!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
19a Z's VB V8/9 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Low start to E's. Start with right hand on the high starting foot hold for E's and left hand on a low undercling. There was once a proper sit start project here but most of the holds exfoliated.
\end{adjustwidth}
\end{adjustwidth}
\phantomsection\label{tp:E7}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/E7_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/E7_c.png}
	\end{overpic}
	\end{center}
\phantomsection\label{tp:enchilada}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/enchilada2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/enchilada2_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\phantomsection\label{tp:little enchilada}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/littleEnchilada_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/littleEnchilada_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\phantomsection\label{tp:Bubbler}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/bubbler_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/Main/bubbler_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
22a Chillum Sit V7 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{sm:Big area map}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/big_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/big_c.png}
	\end{overpic}
	\end{center}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
3 Bitchin Arête V6 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Sit start as for Bitchin Corners sit and climb the right side of the arête.
\end{adjustwidth}
\phantomsection\label{tp:Bitchin Corners}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/bitchin_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/bitchin_c.png}
	\end{overpic}
	\end{center}
\phantomsection\label{tp:Hueco Wabo}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/hueco_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/hueco_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Baldo}
	\setbox0=\hbox{\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/baldo_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/baldo_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Crazy Cool}
	\setbox0=\hbox{\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/crazyCool_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/crazyCool_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:hydro}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/hydro_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/hydro_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\phantomsection\label{tp:Berned}
	\setbox0=\hbox{\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/berned_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/berned_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
9 All Berned Down V8 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Sit Start as with hands on a good edge and climb straight up the short overhang to gain friable holds on the blunt arête. This route and its twin, All Berned Up, have been the source of much confusion over the decades.
\end{adjustwidth}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
10 All Berned Up V8 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Start as for All Berned Down but stay lower by Following the a hanging knife edge to the right. Legend tells that there were multiple holds along both sides of the flake, but they all broke off. The new school beta takes advantage of holds on the face and the lip but still tops on the far right.
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:Berned All Right}
\colorbox{RoyalBlue!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
11 Berned All Right V4 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Traverse left to right across the back wall of the alcove rocking over onto the slab to top. The first ascensionist climbed this from an unintuitive inverted start using a toe hook and hands on a low sloper.
\end{adjustwidth}
\phantomsection\label{tp:bigSlab}
	\setbox0=\hbox{\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/bigSlab_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/bigSlab_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
12 Slabarific V1 \ding{72}\ding{72} \warn\warn
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
13 Big Slab Right V0 \ding{72}\ding{72} \warn
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
14 Pockets V4 \ding{72}\ding{72} \warn
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Classique}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/classique_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/classique_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Small}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/small_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/small_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{sm:Azain area map}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/azain_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/azain_c.png}
	\end{overpic}
	\end{center}
...
\phantomsection\label{tp:The Good}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/good_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/good_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{2em}
...
\needspace{4em}
\needspace{2em}
\phantomsection\label{vr:Project}
\colorbox{black!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
5a Project V?  
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6 Nightcrawler V11 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Nightcrawler}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/nightCrawler_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/nightCrawler_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Azain Spire}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/azainSpire_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/azainSpire_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Blowie}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/blowie_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/blowie_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Azain}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/azainCrack_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/azainCrack_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\phantomsection\label{sm:Child of God area map}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/child_o_god_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/child_o_god_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
...
\phantomsection\label{tp:Locksmith}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/hula_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/hula_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:Brain Hemorrhage}
\colorbox{RoyalBlue!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
2 Brain Hemorrhage V6 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Start as for locksmith and traverse right topping in the vicinity of philanthropy.
\end{adjustwidth}
\phantomsection\label{tp:Philanthropy}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/philanthropy_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/philanthropy_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
3 Philanthropy V4 \ding{72} \warn\warn
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Oregon Arête}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/oregonArete_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/oregonArete_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
4 Oregon Arête V4 \ding{72}\ding{72} \warn
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
5 Full Stroke V2 \ding{72}\ding{72} \warn
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
5a Dream Weaver V2 \ding{72} \warn\warn
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Full Stroke}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/fullStroke_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/fullStroke_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6 Eurovision V2 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6a Sebulba V3 \ding{72}\ding{72} \warn
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:arboretum2}
  \begin{landscape}
	\includepdf[angle=90, picturecommand*={}]{./images/maps/topos/Main/childOfGod_c.png}
  \end{landscape}
	\begin{multicols}{2}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
9 The Arboretum V11 \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
10 The Other Berned V5 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Stand start on small opposing crimps at the far right of the block. The right hand crimp is fairly deep into the crack. Either top straight up or (for full value) traverse the scoop and top in the same spot as The Arboretum
\end{adjustwidth}
	\end{multicols}
\phantomsection\label{tp:Gumby Wall}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/gumby_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/gumby_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{10em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
11 Somewhere In-Between V1 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
12 The Siren V5 \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
13 Gumby Arête V2 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
14 Gumby Slab V1 \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
15 Gumby Crack V0 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Climb the well featured wall to the right of Gumby slab from a stand start. Arguably harder than Gumby Slab.
\end{adjustwidth}
\needspace{10em}
\subsection*{Golden Boy}\phantomsection\label{bf:Golden Boy}
This block is in the alley between the Nightcrawler boulder and the Garden Roof. Access via the walk off trail for the Garden Roof.\\
\needspace{2em}
\phantomsection\label{rt:Golden Boy}
\colorbox{RoyalBlue!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
16 Golden Boy V5  
...
\begin{adjustwidth}{1.3em}{}			
Stand start with a good left hand jug on the left side of the boulder and a right hand side pull in the center of the face. Trend right across the face of the boulder to top out.
  (No Topo)
\end{adjustwidth}
	\end{multicols}
\newpage
...
\phantomsection\label{sm:François area map}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/Big Frank_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/Big Frank_c.png}
	\end{overpic}
	\end{center}
\section{H - François}\phantomsection\label{sa:François}
\phantomsection\label{tp:Geodesic Wiener}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/weiner_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/weiner_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:François}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Main/frank_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Main/frank_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\phantomsection\label{tp:scaryGrandma}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Main/scaryGrandma_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Main/scaryGrandma_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:scaryGrandma2}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/angryMom_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/angryMom_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\phantomsection\label{tp:Fern Sully}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/fern_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/Main/fern_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
