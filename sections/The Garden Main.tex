...
\formatChapter{The Garden Main}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/Garden_c.png}\label{am:The Garden Main Area Overview}
	\end{overpic}
	\end{center}
...
\newpage
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/entrance.png}\label{sm:Entrance Area map}
	\end{overpic}
	\end{center}
...
\newpage
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/fightClub.png}\label{sm:Fight Club Area map}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
...
\newpage
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/undertow.png}\label{sm:Undertow area map}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/koan_c.png}\label{tp:Zen Koan}
	\end{overpic}
	\end{center}
...
\newpage
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/methLab.png}\label{sm:Meth Lab area map}
	\end{overpic}
	\end{center}
...
\newpage
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/big.png}\label{sm:Big area map}
	\end{overpic}
	\end{center}
...
\newpage
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/azain.png}\label{sm:Azain area map}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
...
\newpage
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/Big Frank.png}\label{sm:Big Frank area map}
	\end{overpic}
	\end{center}
