...
\halfPic{}{./maps/area/Garden.png}{The Garden Main Area Overview}
...
\begin{enumerate}[]
	...
	\newline \textbf{Variations:}
	\begin{enumerate}
		\item\label{vr:Spray Against the Undertow} \colorbox{RoyalBlue!20}{\emph{Spray Against the Undertow V6  }  }
		...
		\item\label{vr:Undertow Sit Start} \colorbox{Goldenrod!50}{\emph{Undertow Sit Start V7 \ding{72} \ding{72} \ding{72}  }  }
...
\begin{enumerate}[]
	...
	\newline PLACEHOLDER\
	\setcounter{enumi}{6}
	\item\label{rt:Learys Lunge} \colorbox{Goldenrod!50}{\textbf{Learys Lunge V9 \ding{72} \ding{72} \ding{72}  } }
...
\begin{enumerate}[]
	...
	\newline \textbf{Variations:}
	\begin{enumerate}
		\item\label{vr:Inner Sanctum Sit Start} \colorbox{green!20}{\emph{Inner Sanctum Sit Start V3 \ding{72}  }  }
...
\begin{enumerate}[]
	...
	\newline \textbf{Variations:}
	\begin{enumerate}
		\item\label{vr:Into the Light Assis} \colorbox{Goldenrod!50}{\emph{Into the Light Assis V9  }  }
		\newline (No Topo) 
		\newline PLACEHOLDER\
	\end{enumerate}
	\setcounter{enumi}{8}
