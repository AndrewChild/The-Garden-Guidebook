...
A cluster of boulders situated inbetween the two main trails.\\
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/toiletBowl_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/toiletBowl_c.png}\label{tp:Toilet Bowl}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\includepdf[picturecommand*={\label{pt:Ground up Blowie}\put (10,10) {\colorbox{\chapterColor}{\parbox{0.6\paperwidth}{\textcolor{white}{Andrew strugling to find a finger lock on Ground up Blowie. (Page \pageref{rt:Ground up Blowie})}}}}
}]{./images/blowie.jpg}


	\end{multicols}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/BITW_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/BITW_c.png}\label{tp:Boys in the Woods}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/tonsil_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/tonsil_c.png}\label{tp:Tonsil}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/3star_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/3star_c.png}\label{tp:Three Star Ledge}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/overhand_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/overhand_c.png}\label{tp:Overhand}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/turtle_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/turtle_c.png}\label{tp:Turtle}
	\end{overpic}
	\end{center}
...
Located in the southwest corner of the Garden main, The Fight Club zone is home to the namesake V8 test piece as well as several other quality lines. Flat landings and easy access make this a nice spot to spend some time\\
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/office_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/office_c.png}\label{tp:Office}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/fightClub_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/fightClub_c.png}\label{tp:Fight Club Right Side}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/fightClub2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/fightClub2_c.png}\label{tp:Fight Club Left Side}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/trust_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/trust_c.png}\label{tp:Trust}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/miniMe3_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/miniMe3_c.png}\label{tp:Mini Me 3}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/eDirty_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/eDirty_c.png}\label{tp:E's Dirty B}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/FightClub2.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.7\linewidth}{\textcolor{white}{Michael near the top of Fight Club. (Page \pageref{rt:Fight Club})}}}}

	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/FightClub2.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.7\linewidth}{\textcolor{white}{Michael near the top of Fight Club. (Page \pageref{rt:Fight Club})}}}}
\label{pt:Fight Club}
	\end{overpic}
	\end{center}
...
Directly uphill from Fightclub are a few quality boulders separated by overgrown trails.\\
	...
	\end{multicols}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/undertow2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/undertow2_c.png}\label{tp:Undertow2}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/undertow_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/undertow_c.png}\label{tp:Undertow}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/Riptide.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.7\linewidth}{\textcolor{white}{Rob on Riptide. (Page \pageref{rt:Riptide})}}}}

	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/Riptide.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.7\linewidth}{\textcolor{white}{Rob on Riptide. (Page \pageref{rt:Riptide})}}}}
\label{pt:Riptide}
	\end{overpic}
	\end{center}
	...
	\end{multicols}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/carAlarm_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/carAlarm_c.png}\label{tp:Car Alarm Downhill Side}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/carAlarm2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/carAlarm2_c.png}\label{tp:Car Alarm Uphill Side}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/koan_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/koan_c.png}\label{tp:Bubonic Plague}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\cleartoleftpage
	\includepdf[pages=-, picturecommand*={\label{pt:Octernal}\put (10,10) {\colorbox{\chapterColor}{\parbox{0.6\paperwidth}{\textcolor{white}{Carson landing the big throw on Octernal. Classic! (Page \pageref{rt:Octernal})}}}}
}]{./images/Octurnal.jpg}
...
Easily the most recognizable feature at the Garden, the Meth Lab boulder towers over all other stones in the main area. Most climbs for this zone are located in a secluded natural amphitheater on the uphill side of the boulder.\\
	...
	\end{multicols}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/jesus_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/jesus_c.png}\label{tp:Jesus}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
...
\end{adjustwidth}
	...
	\end{multicols}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/Methlab_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/Methlab_c.png}\label{tp:Methlab Backside}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/octurnal2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/octurnal2_c.png}\label{tp:octernal2}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/swollen2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/swollen2_c.png}\label{tp:Swollen Member}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/eboulder3_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/eboulder3_c.png}\label{tp:Gargoyle}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/eboulder2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/eboulder2_c.png}\label{tp:Slam dunk}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/enchilada_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/enchilada_c.png}\label{tp:enchilada}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/bitchin_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/bitchin_c.png}\label{tp:Bitchin Corners}
	\end{overpic}
	\end{center}


	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/hueco_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/hueco_c.png}\label{tp:Hueco Wabo}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/baldo_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/baldo_c.png}\label{tp:Baldo}
	\end{overpic}
	\end{center}
...
Azain is a jumbled collection of rocks which forms the highest point of the Garden main.\\
	...
	\end{multicols}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/good_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/good_c.png}\label{tp:The Good}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/nightCrawler_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/nightCrawler_c.png}\label{tp:Night Crawler}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/azainSpire_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/azainSpire_c.png}\label{tp:Azain Spire}
	\end{overpic}
	\end{center}
...
\parbox{0.95\linewidth}{
\textbf{
9 Azain Crack 5.10b \ding{72}\ding{72} 
}}}
...
\parbox{0.95\linewidth}{
\textbf{
10 Sometimes V3 \ding{72}\ding{72} 
}}}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/locksmith_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/locksmith_c.png}\label{tp:Locksmith}
	\end{overpic}
	\end{center}
...
\parbox{0.95\linewidth}{
\textbf{
11 Locksmith V4 \ding{72}\ding{72}\ding{72} \warn\warn
}}}
...
\parbox{0.95\linewidth}{
\textbf{
12 Philanthropy V4 \ding{72} \warn\warn
}}}
...
\parbox{0.95\linewidth}{
\textbf{
13 Full Stroke V2 \ding{72}\ding{72} \warn
}}}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/arboretum_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/arboretum_c.png}\label{tp:arboretum}
	\end{overpic}
	\end{center}
...
\parbox{0.95\linewidth}{
\textbf{
16 The Arboretum V11 \ding{72}\ding{72}\ding{72} 
}}}
...
\parbox{0.95\linewidth}{
\textbf{
17 The Other Bernd V10* \ding{73} 
}}}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/siren_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/siren_c.png}\label{tp:siren}
	\end{overpic}
	\end{center}
...
\parbox{0.95\linewidth}{
\textbf{
18 The Siren V5 \ding{72}\ding{72}\ding{72} 
}}}
...
\parbox{0.95\linewidth}{
\textbf{
18a The Siren Stand Start V3 \ding{72}\ding{72} 
}}}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/gumby_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/gumby_c.png}\label{tp:Gumby}
	\end{overpic}
	\end{center}
...
\parbox{0.95\linewidth}{
\textbf{
19 Gumby Arete V2 \ding{72}\ding{72} 
}}}
...
\parbox{0.95\linewidth}{
\textbf{
20 Gumby Slab V1 \ding{72}\ding{72}\ding{72} 
}}}
...
\parbox{0.95\linewidth}{
\textbf{
21 Gumby Crack V0 \ding{72}\ding{72} 
}}}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/2blows.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.7\linewidth}{\textcolor{white}{Griffin on Two Blows One Stroke. (Page \pageref{rt:Two Blows One Stroke})}}}}

	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/2blows.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.7\linewidth}{\textcolor{white}{Griffin on Two Blows One Stroke. (Page \pageref{rt:Two Blows One Stroke})}}}}
\label{pt:2blows}
	\end{overpic}
	\end{center}
...
\newpage
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/out/Big Frank_c.png}\label{sm:Big Frank area map}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/angryMom_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/angryMom_c.png}\label{tp:scaryGrandma2}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/out/scaryGrandma_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/out/scaryGrandma_c.png}\label{tp:scaryGrandma}
	\end{overpic}
	\end{center}
...
\end{adjustwidth}
	...
	\end{multicols}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/Smackdown.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.7\linewidth}{\textcolor{white}{Andrew posting up at the start of Smackdown. (Page \pageref{rt:Smackdown})}}}}

	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/Smackdown.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.7\linewidth}{\textcolor{white}{Andrew posting up at the start of Smackdown. (Page \pageref{rt:Smackdown})}}}}
\label{pt:Smackdown}
	\end{overpic}
	\end{center}
	\raggedcolumns
