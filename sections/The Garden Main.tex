...
\phantomsection\label{tp:Overhand}
	\setbox0=\hbox{\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/overhand2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/overhand2_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{10em}
...
\phantomsection\label{tp:Boys in the Woods}
	\setbox0=\hbox{\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/BITW_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=1.0\linewidth]{./images/maps/topos/Main/BITW_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{10em}
...
\phantomsection\label{tp:Fight Club Right Side}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/fightClub_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Fight Club Left Side}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/fightClub2_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\phantomsection\label{tp:Mini Me 2}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/drEvil_c.png}
	\end{overpic}
	\end{center}
\needspace{2em}
...
\phantomsection\label{tp:E's Dirty B}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/eDirty_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Undertow2}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/undertow2_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\needspace{10em}
...
\phantomsection\label{tp:Gargoyle}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/eboulder3_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Bubbler}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/bubbler_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
...
\phantomsection\label{tp:Fern Sully}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Main/fern_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
