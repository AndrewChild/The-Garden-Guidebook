\phantomsection\label{am:The Garden Main Area Overview}
  \begin{landscape}
	\includepdf[angle=90, picturecommand*={}]{./images/maps/area/out/Garden_c.pdf}
  \end{landscape}
\thispagestyle{empty}
...
\phantomsection\label{tp:Boys in the Woods}
	\includepdf[picturecommand*={}]{./images/maps/topos/Main/overhand_boys_c.pdf}
	\begin{multicols}{2}
\needspace{10em}
...
\phantomsection\label{tp:Methlab Backside}
  \begin{landscape}
	\includepdf[angle=90, picturecommand*={}]{./images/maps/topos/Main/Methlab_c.pdf}
  \end{landscape}
	\begin{multicols}{2}
...
\phantomsection\label{tp:arboretum2}
  \begin{landscape}
	\includepdf[angle=90, picturecommand*={}]{./images/maps/topos/Main/childOfGod_c.pdf}
  \end{landscape}
	\begin{multicols}{2}
\needspace{2em}
