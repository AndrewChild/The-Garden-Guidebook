...
A cluster of boulders situated inbetween the two main trails.\\
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/toilet2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/toilet2_c.png}\label{tp:Toilet Bowl}
	\end{overpic}
	\end{center}
...
\parbox{0.95\linewidth}{
\textbf{
5a Cuba Gooding Variation* V3 \ding{72} 
}}}
...
\begin{adjustwidth}{0.5cm}{}			
Climb the slab over a narrow, but flat landing. (No Topo)
\end{adjustwidth}
...
\begin{adjustwidth}{0.5cm}{}			
Climb the dirty slab to the left of the locksmith. (No Topo)
\end{adjustwidth}
...
\parbox{0.95\linewidth}{
\textbf{
7 The Other Berned V10* \ding{73} 
}}}
...
\parbox{0.95\linewidth}{
\textbf{
8 Somewhere In-Between V1  
}}}

\begin{adjustwidth}{0.5cm}{}			
Climb the narrow chimney.
\end{adjustwidth}
...
\parbox{0.95\linewidth}{
\textbf{
9 The Siren V5 \ding{72}\ding{72}\ding{72} 
}}}
...
\parbox{0.95\linewidth}{
\textbf{
9a The Siren Stand Start V3 \ding{72}\ding{72} 
}}}
...
\end{adjustwidth}
	...
	\end{multicols}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/gumbyWall_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/gumbyWall_c.png}\label{tp:Gumby Wall}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
...
\parbox{0.95\linewidth}{
\textbf{
10 Gumby Arête V2 \ding{72}\ding{72} 
}}}
...
\parbox{0.95\linewidth}{
\textbf{
11 Gumby Slab V1 \ding{72}\ding{72}\ding{72} 
}}}
...
\parbox{0.95\linewidth}{
\textbf{
12 Gumby Crack V0 \ding{72}\ding{72} 
}}}
