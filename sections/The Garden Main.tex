...
\formatChapter{The Garden Main}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/area/Garden_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/Garden_c.png}
	\end{overpic}
	\end{center}
\label{am:The Garden Main Area Overview}
...
\includegraphics[width=0.9\linewidth]{./maps/plots//The Garden Main.png}
\end{multicols}
\begin{multicols}{2}
...
\newpage
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/area/entrance.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/entrance.png}
	\end{overpic}
	\end{center}
...
A cluster of boulders situated inbetween the two main trails.\\
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/toiletBowl_c.png}
	\end{overpic}
	\end{center}
\label{tp:Toilet Bowl}
...
\end{adjustwidth}
	...
	\includepdf[picturecommand*={\put (10,10) {\colorbox{\chapterColor}{\parbox{0.6\paperwidth}{\textcolor{white}{Andrew strugling to finde a finger lock on Ground up Blowie (Page \pageref{rt:Ground up Blowie})}}}}}
]{./images/blowie.jpg}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/tonsil_c.png}
	\end{overpic}
	\end{center}
\label{tp:Tonsil}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/3star_c.png}
	\end{overpic}
	\end{center}
\label{tp:Three Star Ledge}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/overhand_c.png}
	\end{overpic}
	\end{center}
\label{tp:Overhand}
...
\newpage
	\end{multicols}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/area/fightClub.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/fightClub.png}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
\label{sm:Fight Club Area map}
...
\end{adjustwidth}
	...
	\end{overpic}
	\end{center}
\label{tp:Fight Club Right Side}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/miniMe3_c.png}
	\end{overpic}
	\end{center}
\label{tp:Mini Me 3}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/FightClub2.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.8\linewidth}{\textcolor{white}{Michael near the top of Fight Club. (Page \pageref{rt:Fight Club})}}}}

	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/FightClub2.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.8\linewidth}{\textcolor{white}{Michael near the top of Fight Club. (Page \pageref{rt:Fight Club})}}}}
...
\newpage
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/area/undertow.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/undertow.png}
	\end{overpic}
	\end{center}
\label{sm:Undertow area map}
...
\end{adjustwidth}
	...
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/Riptide.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.8\linewidth}{\textcolor{white}{Rob on Riptide (Page \pageref{rt:Riptide})}}}}

	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/Riptide.jpg}\put (0,5) {\colorbox{\chapterColor}{\parbox{0.8\linewidth}{\textcolor{white}{Rob on Riptide (Page \pageref{rt:Riptide})}}}}
...
\label{pt:Riptide}
	...
	\raggedcolumns
	\begin{multicols}{2}
\label{tp:Car Alarm Downhill Side}
...
\end{adjustwidth}
	...
	\end{overpic}
	\end{center}
\label{tp:Car Alarm Uphill Side}
...
\end{adjustwidth}
	...
	\cleartoleftpage
	\includepdf[pages=-, picturecommand*={\put (10,10) {\colorbox{\chapterColor}{\parbox{0.6\paperwidth}{\textcolor{white}{Carson landing the big throw on Octernal. Classic! (Page \pageref{rt:Octernal})}}}}}
]{./images/Octurnal.jpg}
\label{pt:Octernal}

\newpage
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/area/methLab.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/methLab.png}
	\end{overpic}
	\end{center}
\label{sm:Meth Lab area map}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/Methlab_c.png}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/enchilada_c.png}
	\end{overpic}
	\end{center}
\label{tp:enchilada}
...
\newpage
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/area/big.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/big.png}
	\end{overpic}
	\end{center}
\label{sm:Big area map}
...
\newpage
	\end{multicols}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/area/azain.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/azain.png}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
\label{sm:Azain area map}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/locksmith_c.png}
	\end{overpic}
	\end{center}
\label{tp:Locksmith}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/arboretum_c.png}
	\end{overpic}
	\end{center}
\label{tp:arboretum}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/siren_c.png}
	\end{overpic}
	\end{center}
\label{tp:siren}
...
\newpage
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/area/Big Frank.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/Big Frank.png}
	\end{overpic}
	\end{center}
\label{sm:Big Frank area map}
