...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
7 Mini Hydro Tube V1*  \warn\warn
}}}
\begin{adjustwidth}{1.3em}{}			

Climbs a dirty water groove on the downhill face of the boulder. This route is taller than it looks and the top is pure choss. There is a bolted anchor up there so maybe just TR it instead.
  (No Topo)
\end{adjustwidth}
...
\needspace{2em}
\phantomsection\label{rt:Big Slab}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
10 Big Slab V1*  
...
Climb the tall slab however you like. This could also be easily top roped from the bolted anchor at the top of the boulder.
  (No Topo)
\end{adjustwidth}
...
Sit start under a small roof. Climb through pockets to a long and (typically) dirty slab.
  (No Topo)
\end{adjustwidth}
