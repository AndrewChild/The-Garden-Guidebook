...
\end{adjustwidth}
	...
	\end{multicols}
\phantomsection\label{pt:Ground up Blowie}
	\includepdf[picturecommand*={\put (10,10) {
\colorbox{\chapterColor}{
\parbox{0.6\paperwidth}{
\textcolor{white}{
Andrew strugling to find a finger lock on Ground up Blowie. \vpageref[][Description]{rt:Ground up Blowie}
}}}}
}]{./images/blowie.pdf}
...
The faces on the backside of this boulder have been discoverd and forgotten several times over the years. Reestablishing these lines is a project for the future.
  (No Topo)
\end{adjustwidth}
...
Start straddlinga blunt corner with your left hand on a lemon sized knob and right on a low sidepull crimp, Crank to a jug and move right into top of Dr. Evil. Also known as Macro Me. Starting as for Mini Me is also a valid interpretation of this line.
\end{adjustwidth}
...
sit start in compression with left hand on a low sloper sidepull and right hand on the arête. Pull some tricky moves to gain better holds either rolling onto the right hand slab early or staying on the arête the whole way. Starting "one move in" with your right hand on the good obvious sidepull is an all together more enjoyable experience if a little easier.
\end{adjustwidth}
...
\phantomsection\label{pt:Fight Club}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/FightClub2.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
Michael near the top of Fight Club. \vpageref[][Description]{rt:Fight Club}
}}}}

	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/FightClub2.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
Michael near the top of Fight Club. \vpageref[][Description]{rt:Fight Club}
...
This obvious highball line doesn't get done as often as the other routes on the boulder.
\end{adjustwidth}



\phantomsection\label{pt:Riptide}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/Riptide.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
Rob on Riptide. \vpageref[][Description]{rt:Riptide}
}}}}

	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/Riptide.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
Rob on Riptide. \vpageref[][Description]{rt:Riptide}
...
\end{adjustwidth}
	...
	\end{multicols}
\phantomsection\label{pt:Octernal}
    \clearpage
    \ifodd\value{page}\hbox{}\newpage\fi
	\includepdf[pages=-, picturecommand*={\put (10,10) {
\colorbox{\chapterColor}{
\parbox{0.6\paperwidth}{
\textcolor{white}{
Carson landing the big throw on Octernal. Classic! \vpageref[][Description]{rt:Octernal}
}}}}
}]{./images/Octurnal.pdf}
...
For many this is the local testpiece. Start sitting with left hand on a sloping triangular rib and right hand on a slopey crimp at the arête. Crank a few hard moves to gain the lip then traverse left through a crimp rail to a pumpy top out. Originally known as "Tom's bad trip".
\end{adjustwidth}
...
Stand start with your right hand on an incut sloper around the corner and left on a sidepull cutout. Move up the steep face without dabbing. 
  (No Topo)
\end{adjustwidth}
...
\phantomsection\label{tp:Turd Pary}
...
This bulbus semi hanging boulder is directly uphill of Octernal.\\
...
Stand start with hands on opposed sidepulls using the cheater stone below as a foot. A few techy moves gains an airy top out.
  (No Topo)
\end{adjustwidth}
...
Stand start with your right hand above head height on the juggy part of the arête and left hand a little lower on an undercling. Climb into the light.
  (No Topo)
\end{adjustwidth}
...
\phantomsection\label{pt:2blows}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/2blows.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
Griffin on Two Blows One Stroke. \vpageref[][Description]{rt:Two Blows One Stroke}
}}}}

	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/2blows.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
Griffin on Two Blows One Stroke. \vpageref[][Description]{rt:Two Blows One Stroke}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
2 François V3* \ding{72}\ding{72} \warn\warn
}}}
\begin{adjustwidth}{1.3em}{}			
...
\end{adjustwidth}
	...
	\end{multicols}
\phantomsection\label{pt:Smackdown}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/Smackdown.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
Andrew posting up at the start of Smackdown. \vpageref[][Description]{rt:Smackdown}
}}}}

	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/Smackdown.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
Andrew posting up at the start of Smackdown. \vpageref[][Description]{rt:Smackdown}
