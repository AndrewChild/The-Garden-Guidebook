...
\newpage
			\halfPic{./maps/area/Big Frank.png}{Big Frank area map}
...
1 Big Frank V3*  
			...
			\end{adjustwidth}
				...
				\halfPic{./maps/topos/angryMom_c.png}{Scary Grandma 2}
...
3 Angry Mom V2 \ding{72}\ding{72} \warn
			...
			\end{adjustwidth}
					...
					\halfPic{./maps/topos/scaryGrandma_c.png}{Scary Grandma}
