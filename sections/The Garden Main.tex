...
\textcolor{white}{
Andrew struggling to find a finger lock on Ground up Blowie. \vpageref[][Description]{rt:Ground up Blowie}
}}}}
}]{./images/blowie.pdf}
...
Start standing with left hand gaston and right hand jug side pull. Crank some powerful moves on bad feet and follow the line of crimps to a top out left.
\end{adjustwidth}
...
start at the bottom of an obvious seam, climb up and left until the seam evaporates. Traditionally the climb ended here (drop off), but it seems possible to continue up to the top of the formation if you are brave enough. Maybe that's been done before, who knows.
\end{adjustwidth}
