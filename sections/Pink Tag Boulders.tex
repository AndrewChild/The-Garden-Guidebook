...
Sit start the dab rig. Begin in compression way under the roof with left hand on either in cut edge and right hand on some marginal nothing. Squeeze out the steep prow.
\end{adjustwidth}
