...
\raggedcolumns
\begin{multicols}{2}
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./maps/qr//Pink Tag Boulders_qr.png}}% Store image in \box0
...
\phantomsection\label{pt:pinkTag}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/pinkTagSign.jpg}\put (0,5) {
...
All but one of the climbs in this area are downhill of this sign.
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/pinkTagSign.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
All but one of the climbs in this area are downhill of this sign.
...
\phantomsection\label{tp:Aquamarine}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/aquamarine_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/aquamarine_c.png}
	\end{overpic}
	\end{center}
