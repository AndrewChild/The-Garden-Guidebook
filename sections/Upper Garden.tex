...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./maps/qr//Dr. Strangelove_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./maps/qr//Dr. Strangelove_qr.png}
\end{center}
\begin{center}
...
\phantomsection\label{tp:MGB}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/MGB_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/MGB_c.png}
	\end{overpic}
	\end{center}
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./maps/qr//Machete Monkey_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./maps/qr//Machete Monkey_qr.png}
\end{center}
\begin{center}
...
\phantomsection\label{sm:Middle Garden}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/area/out/MiddleGarden.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/out/MiddleGarden.png}
	\end{overpic}
	\end{center}


\section{E - Middle Garden}\phantomsection\label{sa:Middle Garden}
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./maps/qr//Middle Garden_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./maps/qr//Middle Garden_qr.png}
\end{center}
\begin{center}
...
\phantomsection\label{tp:Deep Sea Diver}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/deepSea_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/deepSea_c.png}
	\end{overpic}
	\end{center}
...
\phantomsection\label{tp:Jaws}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/Jaws_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/Jaws_c.png}
	\end{overpic}
	\end{center}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
7 Prince Albert V4/5 \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
8 Things Fall Apart* V7 \ding{72}\ding{72}\ding{72} \warn
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
9 Easy Up, Easy Down V0 \ding{72} \warn\warn
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Prince Albert}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/princeAlbert_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/princeAlbert_c.png}
	\end{overpic}
	\end{center}
...
\phantomsection\label{sm:Upper Forest map}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/area/out/upperForest_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/out/upperForest_c.png}
	\end{overpic}
	\end{center}
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./maps/qr//Upper Forest_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./maps/qr//Upper Forest_qr.png}
\end{center}
\begin{center}
...
\phantomsection\label{tp:Story of O}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/storyO_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/storyO_c.png}
	\end{overpic}
	\end{center}
...
\phantomsection\label{tp:Hoggin Dogs}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/hogginDogs_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/hogginDogs_c.png}
	\end{overpic}
	\end{center}
...
\phantomsection\label{tp:Titanium}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/titanium_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/titanium_c.png}
	\end{overpic}
	\end{center}
...
\phantomsection\label{tp:Foxglove}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./maps/topos/foxglove_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/foxglove_c.png}
	\end{overpic}
	\end{center}
