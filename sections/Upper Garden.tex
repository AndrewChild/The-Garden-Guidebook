...
\formatChapter{Upper Garden}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/upperGarden_c.png}\label{am:Armageddon Area Overview}
	\end{overpic}
	\end{center}
...
\newpage
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/entranceUpper.png}\label{sm:Entrance area map}
	\end{overpic}
	\end{center}
...
\newpage
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/area/bread.png}\label{sm:Bread loaf/Scratch and Spliff area map}
	\end{overpic}
	\end{center}
	\raggedcolumns
	\begin{multicols}{2}
