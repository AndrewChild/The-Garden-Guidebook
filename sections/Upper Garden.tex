\phantomsection\label{am:Armageddon Area Overview}
  \begin{landscape}
	\includepdf[angle=90, picturecommand*={}]{./images/maps/area/out/upperGarden_c.png}
  \end{landscape}
\thispagestyle{empty}
...
\phantomsection\label{tp:Scratch and Spliff}
	\includepdf[picturecommand*={}]{./images/maps/topos/Upper/scratchSpliff4_c.png}
	\begin{multicols}{2}
...
\phantomsection\label{tp:Duck Twirler 2}
	...
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{./images/maps/topos/Upper/duckTwirl2_c.png}
	\end{overpic}
	\end{center}
\newpage
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
5 Back Seat Driver V5 \ding{72} \warn
}}}
\begin{adjustwidth}{1.3em}{}			
Start matched on a big under cling. Climb the arête on the left side the avoiding easier terrain to the right until the end. Contrived.
\end{adjustwidth}
...
\newpage
	\begin{multicols}{2}
	\end{multicols}
\phantomsection\label{sm:Forest Road map}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/Forest Road_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/Forest Road_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\section{F - Forest Road}\phantomsection\label{sa:Forest Road}
These boulders are accessed from side trails further up the gravel road from the main Upper Garden trail. See individual approach directions in each boulder's description.\\
\textbf{NOTE: This sub area is still being rediscovered. Look forward to more information in future revisions of this book or contribute your own knowledge on GitHub.}\\
\needspace{10em}
...
\phantomsection\label{sm:Upper Forest map}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/Upper Forest_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/area/out/Upper Forest_c.png}
	\end{overpic}
	\end{center}
	\begin{multicols}{2}
\section{G - Upper Forest}\phantomsection\label{sa:Upper Forest}
This cluster of boulders nestled against the cliff is not far Northwest of the Entrance area however walking straight from that direction will almost certainly get you covered in poison oak. The upper forest is best accessed by walking up the forest road approximately 1/4 mile from the gate then following a feint trail to the upper forest cliff. Follow the cliff for a few hundred yards until you see a secluded grove of boulders.\\
\textbf{NOTE: This sub area is still being rediscovered. Look forward to more information in future revisions of this book or contribute your own knowledge on GitHub.}\\
\phantomsection\label{tp:Gibraltar}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/Economy_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/Economy_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
\subsection*{Gibraltar}\phantomsection\label{bf:Gibraltar}
A short boulder on the side of the trail just north of Pete's Rail.\\
\needspace{2em}
\phantomsection\label{rt:Gibraltar}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
1 Gibraltar V1 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Sit start on a the leftmost of two in cut edges on the face. A few scrunchy moves lead to a low top out.
\end{adjustwidth}
\phantomsection\label{tp:Pete's Rail}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/Petes_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/Petes_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
\subsection*{Pete's Rail}\phantomsection\label{bf:Pete's Rail}
This short but impressive boulder has unfortunately few holds on its overhang face.\\
\needspace{2em}
\phantomsection\label{rt:PR_2}
\colorbox{black!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
2 Project V?  
...
\begin{adjustwidth}{1.3em}{}			
One could imagine climbing the steep face starting from a large under cling edge. It seems futuristically hard though.
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:PR_1}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
3 Right Arête V2 \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Start on a large horizontal edge and climb the right arête of the boulder.
\end{adjustwidth}
\begin{adjustwidth}{0.5cm}{}				
\needspace{4em}
\needspace{2em}
\phantomsection\label{vr:Pete's Rail Dyno}
\colorbox{RoyalBlue!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
3a Pete's Rail Dyno V4 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Dyno from the start of Right Arête to the lip.
  (No Topo)
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{vr:Pete's Rail}
\colorbox{RoyalBlue!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
3b Pete's Rail V4+ \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Highly contrived, but included for historical significance. Start as for Right Arête, but eliminate the arête and climb through the cool crimp on the face. Harder than the dyno.
  (No Topo)
\end{adjustwidth}
\end{adjustwidth}
\phantomsection\label{tp:Apex}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/Apex_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/Apex_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
\subsection*{Apex}\phantomsection\label{bf:Apex}
\needspace{2em}
\phantomsection\label{rt:Apex}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
4 Apex V2 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Sit start with hands on the large ledge, avoid mantling onto the ledge so as not to trivialize the climb. Contrived.
\end{adjustwidth}
\phantomsection\label{tp:Carpet}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/Carpet_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/Carpet_c.png}
	\end{overpic}
	\end{center}
\needspace{10em}
\subsection*{Roll out the Carpet}\phantomsection\label{bf:Roll out the Carpet}
Well featured face with a concerning chasm in the landing formed by an adjacent boulder.\\
\needspace{2em}
\phantomsection\label{rt:Mind the Gap}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
5 Mind the Gap V1 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Sit start using a horn near the bottom of the left arête.
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:Roll out the Carpet}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6 Roll out the Carpet V3 \ding{72}\ding{72} \warn
}}}
\begin{adjustwidth}{1.3em}{}			
Sit start in the middle of the bottom rail. Follow crimps to good holds in a hollow flake to top on the right side of the face or veer left across the face for roughly the same grade. The chasm at the bottom is unnerving but can be partially filled in with a few extra pads.
\end{adjustwidth}
\needspace{10em}
\subsection*{Roof Crack}\phantomsection\label{bf:Roof Crack}
Broken boulder with a cavernous eastern face.\\
\needspace{2em}
\phantomsection\label{rt:RC_1}
\colorbox{Goldenrod!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
7 Chalaza V6/8 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Sit start with hands matched on the hanging flake. Steeper and more technical than most at the Garden.
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:Cracked Egg}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
8 Cracked Egg V2+ \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Sit start on a jagged flake under the chock stone crack.
  (No Topo)
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:Roof Crack}
\colorbox{RoyalBlue!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
9 Roof Crack V4 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Start in the very back of the cave on the corer and follow the crack out of the cave to top out. The dab potential from the surrounding boulders certainly colors the experience.
\end{adjustwidth}
	\end{multicols}
\phantomsection\label{tp:Roof Crack}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/Roof Crack1_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/Roof Crack1_c.png}
	\end{overpic}
	\end{center}
\newpage
	\begin{multicols}{2}
\section{H - Pluto}\phantomsection\label{sa:Pluto}
\needspace{10em}
\subsection*{Pluto}\phantomsection\label{bf:Pluto}
Far from any other boulders in the area, this humble rock sits alone nearly a mile up the logging road from Quartzville Drive. Follow the logging road until is flattens out at the top of the hill, Pluto is just a few feet off the road on the downhill side. If high quality climbing is your only desire this lonely rock probably isn't for you, but if you're the kind of dreamer who looks at the stars in the night sky and wonders what else is out there, maybe you should hike up and find out.\\
\needspace{2em}
\phantomsection\label{rt:Pluto}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
1 Pluto V2 \ding{72} 
...
\begin{adjustwidth}{1.3em}{}			
Sit start on the right side of the boulder with hands in compression, left hand on a broken crimp rail and right on a slopey side pull on the corner. Climb up and left topping in the center of the face.
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:Pluto Arête}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
2 Pluto Arête V2 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Sit start as for Pluto, climb the blunt corner through to the top.
\end{adjustwidth}
\phantomsection\label{tp:Pluto}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/pluto_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/pluto_c.png}
	\end{overpic}
	\end{center}
	\end{multicols}
\clearpage