...
\textbf{NOTE: This sub area is still being rediscovered. Look forward to more information in future revisions of this book or contribute your own knowledge on GitHub.}\\
\phantomsection\label{tp:Economy}
	...
	\end{center}
\needspace{10em}
\subsection*{Economy}\phantomsection\label{bf:Economy}
A short boulder on the side of the trail just north of Pete's Rail.\\
\needspace{2em}
\phantomsection\label{rt:Basic Economy}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
1 Basic Economy V1 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\needspace{2em}
\phantomsection\label{rt:Fitzcarraldo Project}
\colorbox{black!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
2 Fitzcarraldo Project V?  
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
3a Pete's Rail V4 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Start as for Right Arête, but eliminate the arête by using the cool crimp on the face. Dynoing from the start to the top is similarly difficult if not a bit easier.
  (No Topo)
\end{adjustwidth}
\end{adjustwidth}
...
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:Ridin' Dirty}
\colorbox{green!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6 Ridin' Dirty V3 \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Sit start as for Roll out the Carpet but top on the left side of the face.
\end{adjustwidth}
\needspace{2em}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
7 Roll out the Carpet V3 \ding{72}\ding{72} \warn
}}}
\begin{adjustwidth}{1.3em}{}			
Sit start in the middle of the bottom rail. Follow crimps to good holds in a hollow flake to top on the right side of the face. The chasm at the bottom is unnerving but can be partially filled in with a few extra pads.
\end{adjustwidth}
	\end{multicols}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
8 Unnamed V6/7 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
10 Roof Crack V4 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
