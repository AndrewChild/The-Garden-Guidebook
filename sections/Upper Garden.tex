...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
1 Dr. Strangelove V6* \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			

Climb the aesthetic arête from the left (right hand on arête) side. The natural landing is heinous, but can be fixed by laying logs over the chasm. Also known as "The Hook"
\end{adjustwidth}
...
This highball boulder is the first formation you reach first when hiking past Dr. Strangelove.\\
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
1a Machete Man V5* \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			

A mediocre sit start coming from the hole underneath. Right hand obvious edge, ledge hand on a low edge around the corner
  (No Topo)
\end{adjustwidth}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
2 June 24th V7* \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			

Start matched on a jug at the bottom of an offset rail, and move through static crimping fun to the top. A solid, uncontrived boulder problem.
  (No Topo)
\end{adjustwidth}
