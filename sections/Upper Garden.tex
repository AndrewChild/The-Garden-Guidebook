...
\phantomsection\label{am:Armageddon Area Overview}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/area/out/upperGarden_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\raggedcolumns
\begin{multicols}{2}
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Upper Garden_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Upper Garden_qr.png}
\end{center}
\begin{center}
...
\phantomsection\label{sm:Entrance area map}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/area/out/entranceUpper_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//entranceUpper_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//entranceUpper_qr.png}
\end{center}
\begin{center}
...
\phantomsection\label{tp:Pumpkin}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/pSpice_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Baseball}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/baseball_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{sm:Bread loaf/Scratch and Spliff area map}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/area/out/bread_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//The Bread Loaves_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//The Bread Loaves_qr.png}
\end{center}
\begin{center}
...
\phantomsection\label{tp:Bread Loaf}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/breadLoaf_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Bread Loaf2}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/breadLoaf2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Scratch and Spliff 2}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/scratchSpliff2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/scratchSpliff2_c.png}
	\end{overpic}
	\end{center}
...
\phantomsection\label{tp:Scratch and Spliff}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/scratchSpliff_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/scratchSpliff_c.png}
	\end{overpic}
	\end{center}
...
\phantomsection\label{tp:Scratch and Spliff 3}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/scratchSpliff3_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{sm:Strangelove}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/area/out/strangelove_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Dr. Strangelove_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Dr. Strangelove_qr.png}
\end{center}
\begin{center}
\underline{\textcolor{blue}{\href{http://maps.google.com/maps?q=44.44032,-122.58091}{Navigate to this sub area}}}
\end{center}
...
\phantomsection\label{tp:Dr. Strangelove}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/strangeLove_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Kick It}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/kickIt_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:MGB}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/MGB_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Algebra}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/algebra_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{sm:Machete Monkey}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/area/out/Machete.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Machete Monkey_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Machete Monkey_qr.png}
\end{center}
\begin{center}
\underline{\textcolor{blue}{\href{http://maps.google.com/maps?q=44.44034,-122.58015}{Navigate to this sub area}}}
\end{center}
...
\phantomsection\label{tp:Crack}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/crack_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Machete Monkey}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/machete_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:June 24th}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/June24_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Young Ju¢y}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/young_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Duck Twirler 2}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/duckTwirl2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Duck Twirler}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/duckTwirl_c.png}
	\end{overpic}
	\end{center}
...
\phantomsection\label{sm:Middle Garden}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/area/out/MiddleGarden.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Middle Garden_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Middle Garden_qr.png}
\end{center}
\begin{center}
\underline{\textcolor{blue}{\href{http://maps.google.com/maps?q=44.44034,-122.57973}{Navigate to this sub area}}}
\end{center}
...
\phantomsection\label{tp:Deep Sea Diver}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/deepSea_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Back Seat Driver}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/back_seat_driver_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Jaws}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/Jaws_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Prince Albert}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/princeAlbert_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{sm:Upper Forest map}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/area/out/upperForest_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Upper Forest_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Upper Forest_qr.png}
\end{center}
\begin{center}
\underline{\textcolor{blue}{\href{http://maps.google.com/maps?q=44.43944,-122.58402}{Navigate to this sub area}}}
\end{center}
...
\phantomsection\label{tp:Story of O}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/storyO_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Hoggin Dogs}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/hogginDogs_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Titanium}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/titanium_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Foxglove}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Upper/foxglove_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
