...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
3 Little Hesitator* V2 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
4 June 24th V7 \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\needspace{2em}
\phantomsection\label{rt:June 69th Project}
\colorbox{black!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
5 June 69th Project V?  
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
5a June 69th High Start V1 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6 Young Ju¢y V8 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
6a Juice WRLD V4 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
7 Loosey Ju¢y V1 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
9 Anti-Tiff V2 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
10 Screaming at a Wall V2 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
11 Duck Twirler V2 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
12 Deforestation V3 \ding{72}\ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
12a Deforestation Dyno V4 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
...
\phantomsection\label{tp:Duck Twirler}
	...
	\end{multicols}
\phantomsection\label{in:How do We Know Where a Route Starts?}
\parbox{\linewidth}{
\begin{mdframed}[frametitle={How do We Know Where a Route Starts?}, style=textinsert]
\vspace*{-3ex}
\begin{multicols}{2}
The simplest answer to this question is that a route starts wherever everyone agrees that it starts, but where should a route start? Some will tell you that routes should start at the lowest possible point, this can be called the "lowest viable start" (LVS). Another school of thought is that routes should start on a good obvious hold when possible even if that's not the LVS, this theory can be called the "lowest reasonable start" or LRS.
...
This cool mini cliff band is roughly 25' tall and features a hand crack on the left side. The entire wall seeps and the crack in particular is almost always wet. A variety of lines have been climbed and forgotten on this formation over the years, those currently listed below are just guesses.\\
...
Climb the base of the cliff as a left to right traverse.
  (No Topo)
\end{adjustwidth}
...
Climb the hand crack on the left side of the cliff. Maybe better as a TR as the top is a dirty slab.
  (No Topo)
\end{adjustwidth}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
3 Deep Sea Diver Crack* V?  
}}}
\begin{adjustwidth}{1.3em}{}			

Climb a system of thin cracks on the right side of the cliff from an obvious low jug. Be aware that the upper portion of this line is chossy and dirty.
  (No Topo)
\end{adjustwidth}
...
Climb the ledges on the far right of the cliff.
  (No Topo)
\end{adjustwidth}
