...
\phantomsection\label{tp:Scratch and Spliff 2}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/scratchSpliff2_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Scratch and Spliff}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/scratchSpliff_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{tp:Duck Twirler}
	\setbox0=\hbox{\begin{overpic}[width=0.9\linewidth]{./images/maps/topos/Upper/duckTwirl_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
