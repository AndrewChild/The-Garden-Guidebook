...
\begin{adjustwidth}{1.3em}{}			
Highly contrived, but included for historical significance. Start as for Right Arête, but eliminate the arête and climb through the cool crimp on the face. Harder than just dynoing to the top.
  (No Topo)
\end{adjustwidth}
\end{adjustwidth}
...
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
7 Chalaza V6/7 \ding{72}\ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Sit start with hands matched on the hanging flake.
\end{adjustwidth}
\needspace{2em}
