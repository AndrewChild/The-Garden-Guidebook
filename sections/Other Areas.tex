...
\end{adjustwidth}
\needspace{2em}
\phantomsection\label{rt:Geode}
\colorbox{RoyalBlue!20}{
\parbox{0.95\linewidth}{
\hspace{-1ex}\textbf{$\Box$
2 Geode 5.10b \ding{72} 
}}}
\begin{adjustwidth}{1.3em}{}			
Sport, 6 bolts. Good rests separated by tenuous pulls on bad rock. Only time will tell if this line cleans up for now the name sake geode intrusion in the rock near the chains is the only appealing aspect of the route.
  (No Topo)
\end{adjustwidth}
\newpage
