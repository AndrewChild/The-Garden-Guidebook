...
The Upper Garden is bordered by an extensive cliff line which is both longer and (in some places) taller than the Garden Cliffs. Unfortunately in many sections the area around the cliff and the cliff itself are both covered in poison oak. A free rope adorns the cliff above the Dr. Strangelove boulder for anyone who wants it. Said rope exists as the only remnants of a would be developer who found himself surrounded by poison oak and gave up, never to return.
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Highway 11 Wall_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Highway 11 Wall_qr.png}
\end{center}
\begin{center}
...
\textbf{NOTE: Warning the routes on this feature are equipped with "cold shut" bolts. These bolts are often not strong enough to hold weight and should be avoided or only used with extreme caution.}\\
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Highway 11 Pillar_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Highway 11 Pillar_qr.png}
\end{center}
\begin{center}
...
\phantomsection\label{pt:Cascadia}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/photos/CascadiaCave2.jpg}\put (0,5) {
...
\section{D - Cascadia Cave}\phantomsection\label{sa:Cascadia Cave}
...
\section{E - Canyon Creek}\phantomsection\label{sa:Canyon Creek}
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Canyon Creek_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Canyon Creek_qr.png}
\end{center}
\begin{center}
...
\section{F - Horse Rock}\phantomsection\label{sa:Horse Rock}
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Horse Rock_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Horse Rock_qr.png}
\end{center}
\begin{center}
...
\section{G - Gordon Ridge}\phantomsection\label{sa:Gordon Ridge}
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Gordon Ridge_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Gordon Ridge_qr.png}
\end{center}
\begin{center}
...
\section{H - The Menagerie Wilderness}\phantomsection\label{sa:The Menagerie Wilderness}
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//The Menagerie Wilderness_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//The Menagerie Wilderness_qr.png}
\end{center}
\begin{center}
...
\phantomsection\label{pt:pinnacle}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/photos/pinnacle.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
Santiam Pinnacle as seen from the road.
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/photos/pinnacle.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
Santiam Pinnacle as seen from the road.
...
\section{I - Santiam Pinnacle}\phantomsection\label{sa:Santiam Pinnacle}
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Santiam Pinnacle_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Santiam Pinnacle_qr.png}
\end{center}
\begin{center}
...
\section{J - Iron Mountain}\phantomsection\label{sa:Iron Mountain}
...
\phantomsection\label{tp:Big Iron}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Other/bigIron_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//Big Iron_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//Big Iron_qr.png}
\end{center}
\begin{center}
...
\phantomsection\label{tp:Wild Roses}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/maps/topos/Other/wildRoses_c.png}
	\end{overpic}}
	\needspace{\ht0}
	\begin{center}
...
\phantomsection\label{pt:needles}
	\setbox0=\hbox{\begin{overpic}[width=0.8\linewidth]{./images/photos/needles.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
The Needles as seen from NF-1133.
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./images/photos/needles.jpg}\put (0,5) {
\colorbox{\chapterColor}{
\parbox{0.7\linewidth}{
\textcolor{white}{
The Needles as seen from NF-1133.
...
\section{K - The Needles}\phantomsection\label{sa:The Needles}
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr//The Needles_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr//The Needles_qr.png}
\end{center}
\begin{center}
