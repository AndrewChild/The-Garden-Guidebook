...
\section{H - Iron Mountain}\label{sa:Iron Mountain}
...
Iron mountain is a well known hiking trail at the summit of tombstone pass. Although it's iconic spire has been climbed it does not see regular traffic for the obvious reason that it is a dangerous choss pile. The greater area has also been identified as having a limited amount of bouldering potential. To date only one boulder is known to have been devloped.\\
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/bigIron_c.png}\label{tp:Big Iron}
	\end{overpic}
	\end{center}


\needspace{3em}
\subsection*{Big Iron}\label{bf:Big Iron}
...
\end{adjustwidth}
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{./maps/topos/wildRoses_c.png}\label{tp:Wild Roses}
	\end{overpic}
	\end{center}
...
\section{I - The Needles}\label{sa:The Needles}
