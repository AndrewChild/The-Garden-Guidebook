...
\begin{enumerate}[resume]
	...
	\newline Sit start with a juggy left hand sidebpull and right hand on an undercling edge. Pull a few crimpy moves until you can reach a good hold on the arete. Rock over onto the slab and quest to the top. Be sure to clean the upper section before attempting this rig.\
...
\begin{enumerate}[resume]
	\item\label{rt:Angry Mom} \colorbox{black!20}{\textbf{Angry Mom V?  } }
	\newline PLACEHOLDER\
