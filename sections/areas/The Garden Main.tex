...
\halfPic{ (See Page \pageref{rt:Tide Pool})}{./images/Tidepool.jpg}{Rob on Tide Pool}\label{pt:Tidepool}
\begin{enumerate}[resume]
	...
	\begin{enumerate}
		...
		\newline Sit start in the scoop ~4ft right of Undertow dit with left hand on a borken sidepull and right hand on a low undercling, climb into undertow. At one point this line was simply refered to as Undertow, for this book modern naming standards have been conserved.\
	\end{enumerate}
	\item\label{rt:Tide Pool} \colorbox{green!20}{\textbf{Tide Pool V3 \ding{72} \ding{72}  } }
