...
\setbox0=\hbox{\includegraphics[width=0.45\linewidth]{./images/maps/qr/The Garden_qr.png}}% Store image in \box0
\needspace{\ht0}% Need at least the height of \box0
\begin{center}
\includegraphics[width=0.45\linewidth]{./images/maps/qr/The Garden_qr.png}
\end{center}
\begin{center}
