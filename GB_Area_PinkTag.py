...
Formation(name='Jonah\'s Dab Rig',
          gps='44.43995, -122.57522',
          format_options=['suppress_gps'],
          parent=book.subareas['Pink Tag'],
          description='')
Formation(name='Aquamarine',
          gps='44.43996, -122.57527',
          format_options=['suppress_gps'],
          parent=book.subareas['Pink Tag'],
          description='')
Formation(name='Frat House',
          gps='44.43999, -122.57498',
          format_options=['suppress_gps'],
          parent=book.subareas['Pink Tag'],
          description='')
...
Route(name='Aquamarine',
      parent=book.formations['Pissing Boulder'],
      grade=7,
      FA='Kyan Delaney',
      grade_unconfirmed=True,
      description='Squat start with left hand on a shallow horizontal sloper at chest height and right hand on a big side pull edge. Climb left through the hole to top out.',)
Route(name='Stone Ocean',
      parent=book.formations['Pissing Boulder'],
      grade="9-",
      FA='Matthew Dunnavant'
      grade_unconfirmed=True,
      description='Sit start with left hand on a protruding edge and right hand under clinging a wide rib. Pull on and top on the river side of the boulder.',)
