...
Area(name='Pink Tag Boulders',
     ...
     description='Just across the road from the main area lay a few boulders on the banks of the River. Beware that at high flow rates most of the area will be underwater. Since the River is dam controlled the water level can shift rapidy. Consult '
...
Route(name='Jonah\'s Dab Rig',
      ...
      grade=9,
      rating=2,
      description='Start standing in compression with left hand on a good sidepull and right hand on a blocky sloper, both near eye level. Crank a few powerful moves followed by several dabby moves climbing out of a small hole. Not dabbing is a significant contributor to the overall difficulty.')
Route(name='Frat House',
      parent=book.formations['Frat House'],
      grade=2,
      rating=1,
      serious=2,
      description='Sit start with a juggy left hand sidepull and right hand meet hook on the corner of a low protrusion. Pull a few moves in compression before trending right to top over frat mouse. Climbing this with ample padding might recontextualize the star rating and the seriousness.')
Route(name='Frat Mouse',
      parent=book.formations['Frat House'],
      grade=1,
      rating=0,
      serious=1,
      description='Start on a flexing crack in the broken rock. Climb straight up using opposing sidepulls. The landing requires substantial padding to be made safe.')
Route(name='Belushi',
      parent=book.formations['Frat House'],
      grade='5/7',
      rating=2,
...
Route(name='Farley Prep',
      ...
      FA='Jonah Kreitzberg',
      grade_unconfirmed=True,
      description='Sit start with left hand on a small underclinging side pull and right hand on a lump on the arête. The lip is right there, how hard could it be?')
Variation(name='Workshop 68',
          parent=book.routes['Jonah\'s Dab Rig'],
          grade=11,
          FA='Jonah Kreitzberg',
          rating=2,
          description='Sit start the dab rig. Begin in compression way under the roof with left hand on either incut edge and right hand on some marginal nothing. Squeeze out the steep prow.')
