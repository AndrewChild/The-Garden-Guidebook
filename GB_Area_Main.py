...
Route(name='Geodesic Wiener',
      ...
      rating=1,
      grade_unconfirmed=True,
      description='start at the bottom of an obvious seam, climb up and left until the seam evaporates. Traditionally the climb ends here (drop off).')
Route(name='Pseudorapidity',
      ...
      serious=2,
      FA='Kalel Chester',
      description='Start as for Geodesic Wiener and trend right at the end of the seam.')
