...
Topo(name='Berned',
     ...
     width='1.0',
     routes={
         'path454':book.climbs['Berned All Right'],
         'path292':book.climbs['Berned All Right'],
...
Topo(name='Sanitarium',
     parent=book.formations['Sanitarium Spire'],
     paths={
        'topo_o': r'./images/maps/topos/Main/',
        'topo_i': r'./images/maps/topos/Main/'},
     file_name='Sanitarium.svg',
     size='h',
     border='rect750',
     routes={
         'path696':book.climbs['So Easy'],
         'path694':book.climbs['So Easy'],
         'path692':book.climbs['Mr. Torrance'],
         'path594':book.climbs['Mr. Torrance'],
     })
Topo(name='Office',
