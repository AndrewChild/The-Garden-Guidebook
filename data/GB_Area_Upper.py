...
Route(name='Fitzcarraldo Project',
...
Route(name='Ridin\' Dirty',
      parent=book.formations['Roll out the Carpet'],
      grade=3,
      rating=1,
      description='Sit start as for Roll out the Carpet but top on the left side of the face.')      
Route(name='Roll out the Carpet',
      parent=book.formations['Roll out the Carpet'],
      grade=3,
      rating=2,
      serious=1,
      description='Sit start in the middle of the bottom rail. Follow crimps to good holds in a hollow flake to top on the right side of the face. The chasm at the bottom is unnerving but can be partially filled in with a few extra pads.')      
Route(name='Unnamed',
      item_id='RC_1',
      FA='Noah Osman',
