...
Subarea(name='Forest Road',
        #gps='44.43944, -122.58402',
        parent=book.areas['Upper Garden'],
        description='These boulders are accessed from side trails further up the gravel road from the main Upper Garden trail. See individual approach directions in each boulder\'s description.',
        note = 'This sub area is still being rediscovered. Look forward to more information in future revisions of this book or contribute your own knowledge on GitHub.',)  
...
Formation(name='Gibraltar',
           ...
           description='A short boulder on the side of the trail just north of Pete\'s Rail.')
Formation(name='Pete\'s Rail',
           gps='44.44062, -122.58272',
           format_options=['suppress_gps'],
           parent=book.subareas['Upper Forest'],
           description='This short but impressive boulder has unfortunately few holds on its overhang face.')
Formation(name='Apex',
           gps='44.44059, -122.58266',
           format_options=['suppress_gps'],
           parent=book.subareas['Upper Forest'],
           description='')
Formation(name='Roll out the Carpet',
           gps='44.44063, -122.58259',
           format_options=['suppress_gps'],
           parent=book.subareas['Upper Forest'],
           description='Well featured face with a concerning chasm in the landing formed by an adjacent boulder.')
Formation(name='Roof Crack',
           gps='44.44064, -122.58245',
           format_options=['suppress_gps'],
           parent=book.subareas['Upper Forest'],
           description='Broken boulder with a cavernous eastern face.')
...
Route(name='Project',
      ...
      description='One could imagine climbing the steep face starting from a large under cling edge. It seems futuristically hard though.')      
Route(name='Right Arête',
      item_id='PR_1',
      parent=book.formations['Pete\'s Rail'],
      grade=2,
      rating=3,
      description='Start on a large horizontal edge and climb the right arête of the boulder.')   
Route(name='Apex',
      parent=book.formations['Apex'],
      grade=2,
      rating=2,
      description='Sit start with hands on the large ledge, avoid mantling onto the ledge so as not to trivialize the climb. Contrived.')    
Route(name='Mind the Gap',
      parent=book.formations['Roll out the Carpet'],
      grade=1,
      rating=1,
      description='Sit start using a horn near the bottom of the left arête.')         
Route(name='Roll out the Carpet',
      parent=book.formations['Roll out the Carpet'],
      grade=3,
      rating=2,
      serious=1,
      description='Sit start in the middle of the bottom rail. Follow crimps to good holds in a hollow flake to top on the right side of the face or veer left across the face for roughly the same grade. The chasm at the bottom is unnerving but can be partially filled in with a few extra pads.')      
Route(name='Chalaza',
      item_id='RC_1',
      FA='Noah Osman',
      ...
      grade=7,
      rating=2,
      description='Sit start with hands matched on the hanging flake. Steeper and more technical than most at the Garden.')      
Route(name='Cracked Egg',
      parent=book.formations['Roof Crack'],
      grade='2+',
      rating=1,
      description='Sit start on a jagged flake under the chock stone crack.')      
Route(name='Roof Crack',
      parent=book.formations['Roof Crack'],
      grade=4,
      rating=2,
      description='Start in the very back of the cave on the corer and follow the crack out of the cave to top out. The dab potential from the surrounding boulders certainly colors the experience.')      
...
Route(name='Pluto',
      ...
      FA='Andrew Child',
      rating=1,
      description='Sit start on the right side of the boulder with hands in compression, left hand on a broken crimp rail and right on a slopey side pull on the corner. Climb up and left topping in the center of the face.')
Route(name='Pluto Arête',
      parent=book.formations['Pluto'],
      grade=2,
      FA='Michael Gardener-Brown',
      rating=1,
      description='Sit start as for Pluto, climb the blunt corner through to the top.')
...
Route(name='Back Seat Driver',
      ...
      rating=1,
      serious=1,
      description='Start matched on a big under cling. Climb the arête on the left side the avoiding easier terrain to the right until the end. Contrived.')
Route(name='Jaws',
...
Variation(name='Pete\'s Rail',
          ...
          grade='4+',
          rating=1,
          description='Highly contrived, but included for historical significance. Start as for Right Arête, but eliminate the arête and climb through the cool crimp on the face. Harder than the dyno.')
