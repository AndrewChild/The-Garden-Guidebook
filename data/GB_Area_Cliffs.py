...
Formation(name='Cabbage Patch',
          ...
          description='')
Formation(name='Johnny Cash\'s Thunderdome',
          item_id='Thunderdome',
          format_options=['suppress_gps'],
...
Route(name='Daring to Fly',
      ...
      rating=3,
      FA='Micah Klesik',
      description='55\', Sport, 7 bolts. Start on the right side of a small cave and climb the aesthetic pillar.',
      )
Route(name='Community',
      ...
      rating=1,
      FA='Jayson Nissen',
      description='55\', Sport, 7 bolts. Starting in the same alcove as Daring to Fly climb the right facing ramp up and left to a ledgy top. This route has a reputation for being weird and techy, it\'s not the easiest lead at the grade. There are also several cracks where you could practice gear placements on route.',
      )
...
Route(name='My Secret Garden',
      ...
      rating=3,
      FA='Jayson Nissen',
      description='45\', Sport, 6 bolts. Start on a big sloping rail and pull a few moves to maneuver your way under a hanging block. A short boulder problem leads up and around the block onto easier terrain.',
      )
Route(name='Nest',
      parent=book.formations['Garden Cliff Left Side'],
      grade='5.10c',
