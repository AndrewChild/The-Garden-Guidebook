...
Formation(name='Sanitarium Spire',
          gps='44.44055, -122.57560',
          format_options=['suppress_gps'],
          parent=book.subareas['Fight Club'],
          description='A small spire directly uphill of The Office.')
...
Formation(name='Golden Boy',
          gps='44.44089, -122.57542',
          format_options=['suppress_gps'],
          parent=book.subareas['Child of God'],
          description='This block is in the alley between the Nightcrawler boulder and the Garden Roof. Access via the walk off trail for the Garden Roof.')
...
Route(name='Spider Bumps',
      ...
      grade=5,
      rating=1,
      description='Start on a thin crimp rail over am in-the-way rock. Maneuver yourself to a good jug using almost non existent holds while trying not to dab.')
...
Route(name='Goosebumps',
      parent=book.formations['Overhand'],
      grade=6,
      grade_unconfirmed=True,
      FA='Justin David',
      description='Bunchy start in the pit on the left side of the boulder with hands in compression on a column-like blob. Top on the left side of the boulder.')
Route(name='Overhand',
      parent=book.formations['Overhand'],
      grade=8,
      rating=2,
...
Route(name='So Easy',
      parent=book.formations['Sanitarium Spire'],
      grade=0,
      rating=0,
      description='Start on head high holds and climb the triangular face on loose holds.')
...
Route(name='Kelly Kapoor',
      item_id='OB1',
      parent=book.formations['The Office'],
      grade='?',
      description='Climb the left side of the face on the back side of the office boulder. This route has likely been climbed and is documented many times under different names, but the details have been lost to time.')
Route(name='Mr. Torrance',
      parent=book.formations['The Office'],
      grade=3,
      rating=2,
      description='Start on right facing crimps on the right side of the face. Climb left on good feet and bad hands until you can rock over onto the slab and top.')
Route(name='Vince',
...
Route(name='Berned All Right',
      grade=4,
      rating=1,
      FA='Isaac Tuomi',
      parent=book.formations['Big'],
      description='Traverse left to right across the back wall of the alcove rocking over onto the slab to top. The first ascensionist climbed this from an unintuitive inverted start using a toe hook and hands on a low sloper.')
...
Route(name='Golden Boy',
      parent=book.formations['Golden Boy'],
      grade=5,
      description='Stand start with a good left hand jug on the left side of the boulder and a right hand side pull in the center of the face. Trend right across the face of the boulder to top out.', )
Route(name='Chock Stone Highball',
      parent=book.formations['Chock Stone Highball'],
      grade=4,
      serious=2,
      grade_unconfirmed=True,
      description='Climbing this alluring prow to the apex reportedly goes at around V4. Bring a lot of pads.')
...
Variation(name='Uppercut',
          FA='Justin David',
          grade='9/10',
          parent=book.routes['Overhand'],
          description='Start on Goosebumps and link into Overhand.')
...
Variation(name='Leave it to Jesus Sit Start',
          ...
          grade=9,
          rating=1,
          description='Sit start on razor crimps to the lower left of the stand start. This climb has evolved due to multiple hold breaks.')
...
Variation(name='Home Depot',
          ...
          grade=8,
          rating=2,
          description='Climb Harbor Freight but head right at the top through a slot crimp to finish near the top out for Octernal. [Extension Cord, V9] Optionally, continue traversing by down climbing the Sweet Home Traverse and finish as for Octernal Direct.')
...
Variation(name='Z\'s VB',
          parent=book.routes['E\'s'],
          grade='8/9',
          rating=1,
          FA='Zachary Radke',
          description='Low start to E\'s. Start with right hand on the high starting foot hold for E\'s and left hand on a low undercling. There was once a proper sit start project here but most of the holds exfoliated.')
