...
Route(name='MGB Route',
      parent=book.formations['MGBoulder'],
      item_id='MGB',
      grade=4,
      rating=1,
      description='Sit start using single pad edges below the blobby sloper. Harder and weirder than it looks.')
Route(name='Algebra',
