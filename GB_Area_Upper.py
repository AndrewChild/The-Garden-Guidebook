...
Formation(name='Deep Sea Diver',
           ...
           description='This cool mini cliff band is roughly 25\' tall and features a crack on the left side. The entire wall seaps and the crack in particular is almost always wet. Its too bad that this area has been logged, tree that left the large stump above the wall must have been a sight to be seen.')
Formation(name='Jaws',
           parent=book.subareas['Middle Garden'],
           description='Just down hill from the Deep Sea Diver wall is a boulder with a few historic lines that look worth while.')
Formation(name='Prince Albert',
           parent=book.subareas['Middle Garden'],
           description='This cool spire is surprisingly hard to see from the road. Several lines have been established and frogotten on all aspects of the pillar. Watch out for poison oak on the road facing side.')
...
Route(name='Anti-Tiff',
      ...
      rating=2,
      grade_unconfirmed=True,
      description='Stand start and climb the center face however you see fit.')
Route(name='Duck Twirler',
      parent=book.formations['Duck Twirler'],
      grade=2,
      rating=2,
      description='Stand start with a high left hand sidepull and right hand on a slopey rail. Pounce towards a cool pinch near the top of the boulder.')
