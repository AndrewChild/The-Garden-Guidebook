...
Topo(name='Garden Cliff Castle Black Area',
     parent=book.climbs['Castle Black'],
...
Topo(name='Garden Cliff Nest Area',
     ...
     routes={
         ...
         'path601':book.climbs['Ovulation Send-sation Extension'],
         'path604':book.climbs['Ovulation Send-sation Extension'],
     })
Topo(name='Fairy Tale Wall',
     ...
     routes={
         ...
         'path349':book.climbs['Death of Koschei the Deathless'],
         'path347':book.climbs['Baba Yaga'],
